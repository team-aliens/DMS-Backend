...
interface QueryOutingApplicationPort {
    ...
    fun queryAllOutingApplicationVOsBetweenStartAndEnd(start: LocalDate, end: LocalDate, schoolId: UUID): List<OutingApplicationVO>

    fun queryCurrentOutingApplicationVO(studentId: UUID): CurrentOutingApplicationVO?

    fun queryOutingHistoriesByStudentNameAndDate(studentName: String?, schoolId: UUID, date: LocalDate): List<OutingHistoryVO>
