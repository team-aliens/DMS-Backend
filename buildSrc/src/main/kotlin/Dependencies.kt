object Dependencies {
    ...
    // grpc
    const val GRPC_PROTOBUF_JAVA = "com.google.protobuf:protobuf-java:${DependencyVersions.GRPC_JAVA_VERSION}"
    const val GRPC_PROTOBUF_JAVA_UTIL = "com.google.protobuf:protobuf-java-util:${DependencyVersions.GRPC_JAVA_VERSION}"
