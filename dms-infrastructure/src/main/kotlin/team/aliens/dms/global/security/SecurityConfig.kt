    ...
    protected fun filterChain(http: HttpSecurity): SecurityFilterChain {
        ...
        http
            .authorizeHttpRequests { authorize -> authorize
                ...
                .requestMatchers(HttpMethod.GET, "/volunteers/{volunteer-id}/{student-id}/apply").hasAuthority(MANAGER.name)
                .requestMatchers(HttpMethod.DELETE, "/volunteers/{volunteer-id}/{student-id}/reject").hasAuthority(MANAGER.name)
